...
//            	double w=Double.parseDouble(reader.readLine());
	...
	private void withdraw(double balance) throws NumberFormatException, IOException {
		// TODO Auto-generated method stub
		System.out.println("Enter the amount to be withdrawed:");
		double b1 = Double.parseDouble(reader.readLine());
		this.balance = balance -b1;
		
		//balance-=a;
		System.out.println("The amount remaining after  withdrawed:"+balance);
	}
